    ...
    return (
        <>           
                ...
                <div className="d-flex justify-content-end">
                    <button className="btn btn-primary mt-2 mx-2" onClick={handleUpClick}>CAPITALIZE</button>
                    <button className="btn btn-primary mt-2 mx-2"  onClick={handleDownClick}>Lowercase</button>
                    <button className="btn btn-secondary mt-2 mx-2" id="modebut" onClick={props.handleMode}>Mode</button>
                </div>
                <h1>RESULT</h1>
