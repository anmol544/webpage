...
// document.getElementById("exampleFormControlTextarea1").style.backgroundColor= "#a4aba6";
export default function Box(props){
    ...
    return (
        ...
        <>           
                ...
                <textarea className="form-control " id="exampleFormControlTextarea1" style={{backgroundColor:"#e6e8e6"}} onChange={handleOnChange} rows="10" value={inp}></textarea>
                <div className="d-flex justify-content-end">
                    ...
                    <button className={`btn btn-secondary btn-${props.mode} mt-2 mx-2`} id="modebut" onClick={props.changeMode}>Mode</button>
                </div>
                <h1>RESULT</h1>
